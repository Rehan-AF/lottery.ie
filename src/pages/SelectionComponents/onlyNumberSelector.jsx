  ...
  return (
    <>
      ...
      >
        <div className="inline-flex justify-center z-2 mx-1 space-x-1 lg:min-w-[295px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-[#49636e]">
            ...
            >
              <span className="text-[#49636E] pl-1">انتخاب اعداد</span>
              <span className="inline-flex relative pl-1">
                <svg
                  width="15"
                  height="14"
                  viewBox="0 0 15 14"
      ...
      <Modal
        ...
        width={756}
      >
        <div className="flex flex-col justify-between sm:min-h-[100vh] md:min-h-[auto] sm:h-full md:h-full">
          <div>
