...
const NumberSelectorMilli = ({
  ...
  const handleSubmit = () => {
    ...
    dispatch(
      milliSpecialupdate({ index: index, newValue: selectedSpeicalNumbers })
    );
    setTimeout(() => {
          ...
          >
            {winingNumbers[index] ? (
              <>
                ...
                {milliSpecialNumber[index]?.map((val, index) => {
                  return (
                    <div
                      key={index}
                      className={`relative  ${
                    ...
                    >
                      ...
                      <div
                        className={`md:text-[20px] sm:text-[0.875rem] absolute font-black text-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2`}
                      >
                        {val}
                      </div>
                    </div>
...
export default NumberSelectorMilli;
